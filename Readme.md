...
```sh
$ curl -sf https://gobinaries.com/dmattia/node-prune | sh
```

From source:

```
$ go get github.com/dmattia/node-prune
```
...
[![GoDoc](https://godoc.org/github.com/dmattia/node-prune?status.svg)](https://godoc.org/github.com/dmattia/node-prune)
